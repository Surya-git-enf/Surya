...
/* ─────────────────────────────────────────────
   Main — NO scroll-pin, pure CSS auto-spin
───────────────────────────────────────────── */
  ...
  return (
    <>
      {/*
        ...
        The orbit div uses animation: orbitSpin 18s linear infinite.
        This runs 100% independently of scroll.
      */}
      <style>{`
        @keyframes orbitSpin {
        ...
        /* Pause on hover so users can inspect a card without it spinning away */
