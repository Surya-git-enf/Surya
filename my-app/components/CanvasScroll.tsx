...
const PANELS = [
  {
    ...
    lines: [
      { label: "Name", value: "Peddishetti Surya" },
      { label: "Age", value: "20" },
  ...
  },
  {
    ...
    lines: [
      { label: "Course", value: "Diploma in Electronics and Communication Engineering" },
      { label: "Duration", value: "2023 - 2026" },
      { label: "Focus", value: "Coding · Web Development · Systems" },
      { label: "Goal", value: "Build useful real-world products" },
    ],
  },
  {
    label: "Hobbies",
    ...
    lines: [
      { label: "Learning", value: "Coding" },
      { label: "Music", value: "Listening to music" },
      { label: "Relax", value: "Watching movies" },
      { label: "Build", value: "Creative projects" },
    ],
  },
] as const;
    ...
    <div className="relative w-full z-50 bg-black">
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.8) 100%)",
          }}
        />
              ...
              >
                ...
                <div className="flex flex-col gap-4 p-5">
                  ...
                  <div
                    ...
                    style={{ background: `linear-gradient(90deg, ${panel.accentFrom}44, ${panel.accentTo}44)` }}
                  />
