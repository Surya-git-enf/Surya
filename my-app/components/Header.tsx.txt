...
export default function Header() {
  ...
  // Show header after HeroReveal (~100vh scroll or on mount)
  useEffect(() => {
    const onScroll = () => {
      ...
      {visible && (
        ...
        >
          ...
          <button
            ...
            className="w-9 h-9 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-offset-1 transition-all duration-200 hover:scale-105 active:scale-95"
            style={{ ringColor: "#6b8c5a" }}
        ...
        <>
          ...
          >
            <div className="px-5 pt-4 pb-2 border-b border-black/6">
              <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Get in touch</p>
